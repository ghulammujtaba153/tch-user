    ...
    <div className=" pt-[160px] px-4">
      <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-8 lg:gap-14">
        ...
        <div className="flex flex-col font-sans gap-4 w-full lg:w-1/2 px-4 md:px-0">
          ...
          {/* Button */}
          <Link to={"/home/campaigns"} className='w-[150px] h-[45px] bg-secondary text-white flex items-center justify-center gap-2 px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300 mt-4'>
            {data?.buttonText}
