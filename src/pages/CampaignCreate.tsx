...
const CreateCampaignForm: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 pt-[100px] ">
      ...
      <div className='flex flex-col bg-white items-center border-2 border-gray-300 rounded-[40px] p-4 font-onest shadow-md'>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="bg-transparent w-full px-4 py-2 border border-gray-300 cursor-pointer rounded-lg  focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent"
              >
          ...
          <div className="flex gap-4">
            <button
              type="submit"
              disabled={isPending}
              className="px-6 py-2 bg-secondary text-white rounded-full hover:scale-105 transition duration-200"
            >
